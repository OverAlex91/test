...
wp_footer(); ?>
        ...
        <div class="modal__main-text">
            <div class="modal__main-text__form">
                ...
                <form id="telephone_modal" method="post" action="smart.php">
                    <label class="telephone_form_label" for="telephone_modal">Введите ваш номер телефона:</label>
                    ...
                    <span class="telephone_modal_span">*Минимальный заказ 500шт</span>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal_window_thanks">
        <h3 class="modal_window_thanks_text">Спасибо за заявку!</h3>
